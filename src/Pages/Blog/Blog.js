    ...
    <div className="container mx-auto">
      <div className="my-4 border p-3 rounded-lg border-amber-800">
        ...
        <p className="mt-2">
          ...
          <span className="font-bold mr-1">Local (UI) state</span> – Local state
          ...
          <span className="font-bold mr-1">Global (UI) state</span> – Global
          ...
          <span className="font-bold mr-1">Server state</span> – Data that comes
          ...
          much easier.
          <span className="font-bold mr-1">URL state</span> – Data that exists
      ...
      <div className="my-4 border p-3 rounded-lg border-blue-800">
        ...
        <p className="mt-2">
          <span className="font-bold mr-1">Answer:</span>The Prototypal
          ...
          to get and set the [[Prototype]] of an object, we use Object.
      ...
      <div className="my-4 border p-3 rounded-lg border-yellow-400">
        ...
        <p className="mt-2">
          <span className="font-bold mr-1">Answer:</span>The main objective of
          unit testing is to isolate written code to test and determine if it
      ...
      <div className="my-4 border p-3 rounded-lg border-green-500">
        ...
        <p className="mt-2">
          <span className="font-bold mr-1">Answer:</span>Vue provides higher
          customizability and hence is easier to learn than Angular or React.
          Further, Vue has an overlap with Angular and React with respect to
          their functionality like the use of components. Hence, the transition
          to Vue from either of the two is an easy option.
        </p>
      </div>
    </div>
  );
